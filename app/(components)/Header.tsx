...
async function Header() {
  ...
  return (
    <header className="flex justify-between  lg:justify-around items-center shadow-lg  p-3">
      <Link href="/">
        <h1 className="text-md md:text-2xl lg:text-3xl font-bold">Study Group</h1>
      </Link>
      ...
      >
        <input
          ...
          placeholder="Search"
          name="search"
          className="peer focus:outline-none px-6 py-2 border-2 border-gray-300 rounded-full md:w-[300px] lg:w-[400px] xl:w-[500px] w-[200px] hover:bg-gray-200 ease-in-out duration-500"
          required
        />
      ...
      <nav className="flex items-center gap-4 text-sm md:text-xl ">
        <Link
          href="/groups"
